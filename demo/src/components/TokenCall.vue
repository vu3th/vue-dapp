<script setup lang="ts">
  import { ChainId, useEthers, useEthersHooks, Web3Provider } from 'vue-dapp'
  import { useToken } from '../composables/useTokenCall'
  ...
  const doCall = async (provider:Web3Provider, address:string) => {
    try {
      ...
      await call(
        provider,
        provider.network.chainId !== ChainId.Polygon ? 
        '0x6B175474E89094C44Da98b954EedeAC495271d0F' // ether
        : '0x2a88d21c52a9faaac0c458ac092c721c625f8f79' // matic
        , // DAI Mainnet
        address,
      )
    }
...
<template>
  ...
  >
    <div class="max-w-md py-4 px-8 bg-white shadow-lg rounded-lg my-20">  
      <h2 class="text-gray-800 text-3xl font-semibold">useCalls Hook</h2>
